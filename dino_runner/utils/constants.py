...
RUNNING = [
    pygame.image.load(os.path.join(IMG_DIR, "Dino/JonhRun1.0.png")),
    pygame.image.load(os.path.join(IMG_DIR, "Dino/JonhRun2.0.png")),
]
...
JUMPING = pygame.image.load(os.path.join(IMG_DIR, "Dino/JonhRun1.0.png"))
